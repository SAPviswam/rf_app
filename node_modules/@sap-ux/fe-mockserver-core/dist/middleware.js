...
async function createMockMiddleware(newConfig, app, fileLoader, metadataProcessor) {
    var _a;
    const log = (_a = newConfig.logger) !== null && _a !== void 0 ? _a : (0, logger_1.getLogger)('server:ux-fe-mockserver', !!newConfig.debug);
    ...
    const oDataHandlerPromises = newConfig.services.map(async (mockServiceIn) => {
        ...
        try {
            ...
            const dataAccess = new dataAccess_1.DataAccess(mockService, metadata, fileLoader, newConfig.logger);
            if (mockService.watch) {
