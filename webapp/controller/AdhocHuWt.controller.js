    ...
    function (Controller, MessageToast, UIComponent, Device) {
        ...
        return Controller.extend("com.app.rfapp.controller.AdhocHuWt", {
            ...
            onSecondBackBtnPress_CAHU: function () {
                ...
                this.getView().byId("idSecSCHuInput_CAHU").setValue();
                this.getView().byId("idWPTInput_CAHU").setValue();
                this.getView().byId("idsrcBinInput_CAHU").setValue();
                this.getView().byId("idDestBinInput_CAHU").setValue();
                this.getView().byId("idDestHuInput_CAHU").setValue();
